...
ON
  ...
  TT1.table_schema = TT3.table_schema and
  TT1.table_schema = TT4.table_schema
order by
  concat(TT1.table_schema, '.', SUBSTR(wp_users, 1, length(wp_users)-5)),
  concat(TT1.table_schema, '.', SUBSTR(wp_posts, 1, length(wp_posts)-5))
;
